...
"background-color: rgb(95, 99, 115);")
        ...
        self.gridLayout.addWidget(self.agregarInicio_pushButton, 11, 1, 1, 1)
...
"color: rgb(243, 243, 243);")
        ...
        self.gridLayout.addWidget(self.velocidad_lineEdit, 6, 1, 1, 1)

        self.mostrar_pushButton = QPushButton(self.groupBox)
        self.mostrar_pushButton.setObjectName(u"mostrar_pushButton")

        self.gridLayout.addWidget(self.mostrar_pushButton, 13, 1, 1, 1)

        self.BluespinBox = QSpinBox(self.groupBox)
        self.BluespinBox.setObjectName(u"BluespinBox")
        self.BluespinBox.setMaximum(255)

        self.gridLayout.addWidget(self.BluespinBox, 9, 1, 1, 1)
...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.gridLayout.addWidget(self.agregarFinal_pushButton, 12, 1, 1, 1)
